...
/// A 4x4 ``Matrix`` containing Float values.
///
...
extension Float4x4: Sendable {
	
}

extension Float4x4: SIMDConvertible {
	public typealias SIMDRepresentation = simd_float4x4
...
extension Float4x4: MatrixIdentity {
	public static var identity: Self {
		Self(matrix_identity_float4x4)
	}

	public var isIdentity: Bool {
		storage == matrix_identity_float4x4
	}
...
extension Float4x4: MatrixQuaternionConvertible {
...
extension Float4x4: MatrixRotation {
...
extension Float4x4: MatrixScale {
...
extension Float4x4: MatrixTranslation {
	public typealias Translation = Float3
...
extension Float4x4: MatrixTransposable {
...
extension Float4x4: MatrixVectorMath {
	...
	public static func * (lhs: VectorRepresentation, rhs: Self) -> VectorRepresentation {
		var temp = simd_float4(lhs[0], lhs[1], lhs[2], .zero)
...
//
	#warning("Float4x4 is not implemented on this platform.")
#endif

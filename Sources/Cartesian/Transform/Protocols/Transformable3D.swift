...
///
	mutating func transform<T: Transform3Protocol>(by transform: T) where T.Component == Component
...
///
	func transform<T: Transform3Protocol>(by transform: T) -> Self where T.Component == Component
}

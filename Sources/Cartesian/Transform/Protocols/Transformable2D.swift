...
///
	mutating func transform<T: Transform2Protocol>(by transform: T) where T.Component == Scalar
...
///
	func transformed<T: Transform2Protocol>(by transform: T) -> Self where T.Component == Scalar
}
